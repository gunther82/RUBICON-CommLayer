 ...
 * This class implements a Java interface to the 'LearningModuleFloatCmdMsg'
 * message type.
 */

public class LearningModuleFloatCmdMsg extends net.tinyos.message.Message {
    ...
    /** Create a new LearningModuleFloatCmdMsg of size 100. */
    public LearningModuleFloatCmdMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new LearningModuleFloatCmdMsg of the given data_length. */
    public LearningModuleFloatCmdMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new LearningModuleFloatCmdMsg with the given data_length
     * and base offset.
     */
    public LearningModuleFloatCmdMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new LearningModuleFloatCmdMsg using the given byte array
     * as backing store.
     */
    public LearningModuleFloatCmdMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public LearningModuleFloatCmdMsg(byte[] data, int base_offset) {
     ...
     */
    public LearningModuleFloatCmdMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new LearningModuleFloatCmdMsg embedded in the given message
     * at the given base offset.
     */
    public LearningModuleFloatCmdMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public LearningModuleFloatCmdMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <LearningModuleFloatCmdMsg> \n";
      try {
    ...
    /**
     * Return whether the field 'rows' is signed (true).
     */
    ...
    /**
     * Return whether the field 'cols' is signed (true).
     */
