 ...
 * This class implements a Java interface to the 'BroadcastCmdMsg'
 * message type.
 */

public class BroadcastCmdMsg extends net.tinyos.message.Message {
    ...
    /** Create a new BroadcastCmdMsg of size 5. */
    public BroadcastCmdMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new BroadcastCmdMsg of the given data_length. */
    public BroadcastCmdMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BroadcastCmdMsg with the given data_length
     * and base offset.
     */
    public BroadcastCmdMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BroadcastCmdMsg using the given byte array
     * as backing store.
     */
    public BroadcastCmdMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public BroadcastCmdMsg(byte[] data, int base_offset) {
     ...
     */
    public BroadcastCmdMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new BroadcastCmdMsg embedded in the given message
     * at the given base offset.
     */
    public BroadcastCmdMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public BroadcastCmdMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <BroadcastCmdMsg> \n";
      try {
    ...
    /**
     * Return the value (as a int) of the field 'clock'
     */
    public int get_clock() {
        return (int)getUIntBEElement(offsetBits_clock(), 16);
    }

    /**
     * Set the value of the field 'clock'
     */
    public void set_clock(int value) {
        setUIntBEElement(offsetBits_clock(), 16, value);
    }
